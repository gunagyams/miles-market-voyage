...
export default function ThreeStepProcess() {
  return (
    <div className="bg-[#fefbf3] mt-[-30px] w-[90%] py-12 px-6 text-center text-[#0e1e3c] relative z-10 mx-auto rounded-xl shadow-xl border border-gray-100">
      <div className="max-w-4xl mx-auto mb-8">
        <h2 className="text-2xl md:text-3xl font-gilda font-semibold mb-4 text-navy">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="step-card group">
          ...
          <h3 className="text-lg font-medium text-gold mb-1">Step 1</h3>
          <h2 className="text-xl font-semibold mb-2 font-gilda">Browse deals</h2>
        ...
        <div className="step-card group">
          ...
          <h3 className="text-lg font-medium text-gold mb-1">Step 2</h3>
          <h2 className="text-xl font-semibold mb-2 font-gilda">Calculate your cost</h2>
          <p className="text-gray-600 font-jakarta text-sm">
        ...
        <div className="step-card group">
          ...
          <h3 className="text-lg font-medium text-gold mb-1">Step 3</h3>
          <h2 className="text-xl font-semibold mb-2 font-gilda">Place your order</h2>
          <p className="text-gray-600 font-jakarta text-sm">
