        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <span className="text-gold mr-2">📱</span>
                <a href="tel:+97144001234" className="text-gray-300 hover:text-gold transition-colors duration-200">+971 4 400 1234</a>
              </li>
              <li className="flex items-start">
                <span className="text-gold mr-2">✉️</span>
                <a href="mailto:info@milesmarket.com" className="text-gray-300 hover:text-gold transition-colors duration-200">info@milesmarket.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-400 hover:text-gold text-sm transition-colors duration-200">Terms & Conditions</a>
