  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "We've received your quote request. We'll get back to you shortly.",
      });
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-300">
              Fill out the form below to receive a personalized quote for your miles purchase.
          ...
          <div className="bg-white text-navy rounded-xl overflow-hidden shadow-xl">
            <form onSubmit={handleSubmit} className="p-6 md:p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="miles" className="block text-sm font-medium text-gray-700 mb-1">Miles Amount</label>
                  <input
                    type="number"
                    id="miles"
                    name="miles"
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  This is an approximate total. Final pricing will be confirmed in your personalized quote.
                </p>
              </div>
